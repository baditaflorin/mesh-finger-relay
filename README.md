...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-finger-relay-aa66ff)](https://baditaflorin.github.io/mesh-finger-relay/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-finger-relay/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Collaborative finger painting; 3 seconds per turn, rotating.

**Live → https://baditaflorin.github.io/mesh-finger-relay/**

**Source → https://github.com/baditaflorin/mesh-finger-relay**
...
git clone https://github.com/baditaflorin/mesh-finger-relay
cd mesh-finger-relay
npm install
npm run dev
```
...
- `mesh-finger-relay:signalingUrl`
- `mesh-finger-relay:turnTokenUrl`
- `mesh-finger-relay:iceServers`
- `mesh-finger-relay:room`
